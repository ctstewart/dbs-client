...
describe('getters', () => {
    it('planTotal', () => {
        ...
        mutations.toggle(state, 'militaryOld')

        mutations.setMixAndMatchPlans(state, {index: 0, value: 5})

        for (var i=0; i < 3; i++)mutations.incrementConnectedDevice(state, 0)

        const result = getters.planTotal(state, getters)
